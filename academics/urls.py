...
urlpatterns = [
    ...
    path("curriculum/pbm-schedule/<int:pk>/edit/", views.pbm_schedule_update, name="pbm_schedule_edit"),
    path("curriculum/pbm-schedule/<int:pk>/delete/", views.pbm_schedule_delete, name="pbm_schedule_delete"),
